const base64_decoder = {
  title: 'Base64 エンコーダー / デコーダー（解説付き）｜プライベート・ブラウザ上で動作',
  description:
    'ブラウザ上で Base64 および Base64URL のペイロードをエンコード・デコードできます。データはすべて手元のデバイスに留まります。さらに、Base64 とは何か、どのように動作し、いつ使うのかも解説します。',
  encoder: 'エンコーダー',
  decoder: 'デコーダー',
  subtitle:

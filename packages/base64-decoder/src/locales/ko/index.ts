const base64_decoder = {
  title: 'Base64 인코더 및 디코더, 원리까지 설명 | 안전하며 브라우저에서 바로 동작',
  description:
    '브라우저에서 Base64와 Base64URL 데이터를 인코딩하고 디코딩하세요. 모든 데이터는 기기 안에서만 처리됩니다. 또한 Base64가 무엇인지, 어떻게 동작하는지, 언제 사용하는지도 설명합니다.',
  encoder: '인코더',
  decoder: '디코더',
  subtitle:

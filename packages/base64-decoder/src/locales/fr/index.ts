const base64_decoder = {
  title: 'Encodeur et décodeur Base64 | Rapide, privé, dans le navigateur',
  description:
    'Encodez et décodez des données Base64 et Base64URL dans le navigateur. Tout reste sur votre appareil.',
  encoder: 'Encodeur',
  decoder: 'Décodeur',
  subtitle:
